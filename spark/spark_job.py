...
# otlp_exporter = OTLPSpanExporter(endpoint="grpc://jaeger:14250")  # 172.19.0.2 Replace with your OTLP endpoint
otlp_exporter = OTLPSpanExporter(endpoint="http://jaeger:4317")  # 172.19.0.2 Replace with your OTLP endpoint
